...
function renderMiembro(id, rol, requerido, withNA=false) {
  return `<div class="trip-miembro">
    <div class="trip-rol-label">
      ...
      ${withNA?`<label style="margin-left:auto;display:flex;align-items:center;gap:7px;font-size:12px;font-weight:700;color:var(--gris-100);cursor:pointer;text-transform:uppercase;letter-spacing:1px"><input type="checkbox" id="trip_${id}_na" onchange="toggleTripNA('${id}')" style="width:18px;height:18px;cursor:pointer;accent-color:var(--amarillo)"> N/A</label>`:''}
    </div>
